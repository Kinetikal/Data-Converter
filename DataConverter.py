...
FILE_TYPES_OUTPUT = (("CSV (Comma Seperated Value)", ".csv"),("XML (Extensible Markup Language)",".xml"),("JSON (JavaScript Object Notation)",".json"),("MD (Markdown README)",".md"),("HTML (Hypertext Markup Language)", ".html"))
